// utils/utils.js
export const fields = [
    { name: "profile_name", label: "Profile Name", placeholder: "e.g. Ytterbåge", type: "text" },
    { name: "weight_kg_per_m", label: "Weight (kg/m)", placeholder: "e.g. 0.862", type: "number" },
    { name: "length_m", label: "Length (m)", placeholder: "e.g. 83.8", type: "number" },
    ...
    { name: "surface_treatment", label: "Surface Treatment", placeholder: "e.g. Powder Coated", type: "text" },
    { name: "lme_price_eur_per_kg", label: "LME Price (€/kg)", placeholder: "e.g. 7.34", type: "number" },
    { name: "date", label: "Date", placeholder: "", type: "date" }
];
export const URL="https://quote-predictor-api.onrender.com/predict";
export const initialFormState = Object.fromEntries(fields.map(f => [f.name, ""]));
